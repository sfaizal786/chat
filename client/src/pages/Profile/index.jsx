...
console.log(error);
   ...
   <div className="flex flx-col gap-10 w-[80vw] md:w-max">
   ...
   />
      ...
      <div className='flex min-w-22 md:min-w-64 flex-col gap-5 text-white items-center justify-center'>
        <div className='w-full'>
         <input placeholder='Employee Id' type="text" disabled value={userInfo.empid} className='rounded-lg p-6 bg-[#2c2e3b] border-none' />
        </div>
        <div className='w-full'>
